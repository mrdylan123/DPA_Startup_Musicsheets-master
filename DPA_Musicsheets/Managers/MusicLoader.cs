...
namespace DPA_Musicsheets.Managers
{
    ...
    public class MusicLoader
    {
        ...
        {
            // Get the file extension so that we know what to work with
        ...
        public string LoadMidiIntoLilypond(Sequence sequence)
        {
            ...
            {
                // Moved this big switch case to TrackHandler.cs
                trackHandler.LoadMidi(sequence, i, lilypondContent);
            }

            // Zet de variabelen
            _beatNote = trackHandler._beatNote;
            _beatsPerBar = trackHandler._beatsPerBar;
            _bpm = trackHandler._bpm;
        ...
        // Moved this code to PDFSaver.cs
        internal void SaveToPDF(string fileName)
        {
            PDFSaver pdfSaver = new PDFSaver();
            pdfSaver.SaveToPDF(fileName, LilypondText);
        }
        ...
        {
            PDFSaver pdfSaver = new PDFSaver();
            pdfSaver.SaveToLilypond(fileName, LilypondText);
        }
